...
songplay_table_create = (""" CREATE TABLE IF NOT EXISTS songplays (songplay_id SERIAL PRIMARY KEY, start_time TIMESTAMP, user_id INT REFERENCES users (user_id), level VARCHAR, song_id VARCHAR REFERENCES songs, artist_id VARCHAR REFERENCES artists, session_id INT, location VARCHAR, user_agent VARCHAR) 
""")
